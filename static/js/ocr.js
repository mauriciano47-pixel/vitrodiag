...
async function runScannerOcr() {
    ...
    const runOcrBtn = document.getElementById('btnRunOcr'); // <- scope correcto
...
function confirmOcrAndCompare() {
    ...
    state.scannerParsedValues = {
        ...
        blowOff: parseInt(document.getElementById('ocrValBlowOff').value) || 325 // <- Bug corregido: usa campo blowOff real
    };
