...
VitroDiag es una plataforma Progressive Web App (PWA) de asistencia óptica y control de moldería para análisis de botellas de vidrio en tiempo real usando la cámara del celular.
...
Desarrollado por: Mauricio Uribe Maldonado (mauriciano47-pixel)
